...
public class BoardManager {
     ...
     * @param pieceType The type of piece to promote to. If none is provided it
     *                  defaults to Queen.
     ...
     *
     * @param player The player to check checkmate for
     * @return boolean
     */
     ...
     *
     * @param player The player whose king it is
