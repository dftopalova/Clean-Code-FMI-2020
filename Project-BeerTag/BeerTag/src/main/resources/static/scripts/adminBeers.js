...
\              </div>
    ...
    $("body").on("click", "#btn-del-beer", function () {
        console.log("REMOVE BEER CLICKED");
        let beerId = $(this).attr('value');
        let tempUrl = beerUrl + `/${beerId}`;
        console.log(tempUrl);
        ...
        swal("Are you sure?", {
            ...
            .then(function () {
                $.ajax({
                    ...
                    error: deleteBeerFail
                });
            });

        function deleteBeerSuccess(res) {
            console.log("DELETE BEER SUCCESS");
            console.log(res);
            swal("Done!", "Beer was successfully removed!", "success");
            refreshBeers()
        }

        function deleteBeerFail(res) {
            console.log("DELETE BEER FAIL");
            console.log(res);
            swal("Oops!", "Something bad happened, sorry.", "error")
        }
